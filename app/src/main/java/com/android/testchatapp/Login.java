                            ...
                            if(s.equals("null")){
                                ...
                                try {
                                    ...
                                    if(!obj.has(user)){
                                        ...
                                        String privKey = FileReadWrite.readTextFile(Login.this, UserDetails.username);
                                        //Toast.makeText(Login.this, "S:" + privKey, Toast.LENGTH_LONG).show();
                                        UserDetails.privateKey = privKey;
